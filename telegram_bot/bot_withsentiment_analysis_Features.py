...
# Fix Hugging Face model loading issues
CACHE_DIR = "./hf_cache"
shutil.rmtree(CACHE_DIR, ignore_errors=True)  # Clear cache to prevent conflicts
...
try:
    ...
    logger.warning(f"Error loading DistilBERT model: {e}. Using alternative model.")
